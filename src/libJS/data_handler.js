...
//
export function copyData(data, id, dataModel) {
...
// };
    ...
    //
    export function requestToServer(type, url, dataType, postData, successFunction, errorFunction, context) {
    ...
    //
    export function loadData(url, postData = {}, dataSet, dataModel, successFunction, errorFunction) {
...
//
export function saveData(data, dataSet, dataModel, successFunction, errorFunction, context) {
