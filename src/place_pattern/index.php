...
<!-- <dialog class="dialog-modal" id="dialogModal">
    ...
    <div class="gridContainer__modal">
        ...
        <main role="main">
            ...
            <section class="right-block__buttons--modal">
                ...
                <button class="button-right" id="btnOkModal"> OK </button>
                <button class="button-right" id="btnCancelModal"> Cancel </button>
                <button class="button-right" id="btnCloseModal"> Close </button>
